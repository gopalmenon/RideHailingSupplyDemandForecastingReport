...
The project team has coded the input values for the regression models.  The input values consist of:
\begin{enumerate}
 \item An order key, comprised of the values for location, weather, traffic, and points of interests. 
 \item The cost, which is the median price of orders for a specific date and time.
 \item And the number of orders for a specific date and time.
\end{enumerate}
With the input values created, the project team can now experiment with multiple regression models.

\section{Stochastic Gradient Descent}
The project team has experimented with the Stochastic Gradient Descent (SGD) model of regression.  The results of the initial regression can be found below.
    \begin{table}[!h] 
    \centering
